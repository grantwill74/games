...
(local [LIVES_DISPLAY_PX LIVES_DISPLAY_PY] [2 12])
...
; GameMap ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(local GameMap {:mt {}})
(fn GameMap.gen [n_truffles n_holes seed]
...
(fn GameMap.clamp_to_bounds [tx ty]
    (local tx (clamp tx 1 (- FIELD_W_T 1 EPS)))
    (local ty (clamp ty 1 (- FIELD_H_T 1 EPS)))
    [tx ty]
)
...
(local Intermissions {
    ...
    :level_complete {
        ...
        :draw (fn [self]
            ...
            (spr self.image INTER_IMG_X
                (- INTER_IMG_Y (* 2 TILE_H_PX)) -1 1 0 0 2 2)
            (print "Stats:" self.text_x (+ self.text_y (* 3 TILE_H_PX)) 12)
            ...
            (print "Press X to continue!" self.text_x
...
; easy refactor would be to run this in the constructor, but I like having
; the table there for documentation
(fn GameState.mt.next_level [self seed]
    (inc! self.level)

    (set self.pig (Actor.new 1 1))
    (set self.map (GameMap.gen 3 (. LEVEL_DIFF self.level) seed))
    (set self.auto_digs [])
    
    (set self.first_dig true)
    (set self.last_dig_time 0)
    (set self.truffles_gotten 0)
    (set self.n_flags 3)
    ...
    ; restore the map. this is a weird side effect of using the map to store 
    ; tile state, but this would not be a bad way to save scratch RAM on an old
    ; computer, which the TIC 80 is trying to emulate
    (for [x 0 29] ; magic numbers here: 30 is the screen width, 29 is inclusive
        (for [y 0 16]   ; last cell, same for 16 (17 is the height)
            (mset x y   ; we grab the tiles from two screens over
                (mget (+ x 60) y)) ; which is a fresh screen 
        )
    )
    ; I could look in to using memcpy using the RAM map for this kind of thing
    ; in the future...
)
...
(fn draw_repeated_sprite [count sprite px_left py transparent_idx space]
    (var px px_left)

    (for [which_one 0 (- count 1)]
        (spr sprite px py transparent_idx)
        (set px (+ px TILE_W_PX (if space space 0))))
)
...
(fn GameState.mt.draw_lives [self]
    (draw_repeated_sprite self.lives_remaining PIG_SPRITE
        LIVES_DISPLAY_PX LIVES_DISPLAY_PY 0 2)
)
...
;    (set Intermissions.level_complete.which_level 1)
;    (set Intermissions.level_complete.time_taken 10000)
...
;; 048:0092290002999920229999223399993333a99a33022aa2200220022002300320
;; 049:02999920229999923399999233a99a2302200220022002200330000000000000
;; 050:0092290002999920229999223399993333a99a33022aa2200220022002300320
;; 051:02999920299999222999993332a99a3302200220022002200000033000000000
;; 052:000999000099290000922990209229900293399000a33a000002200000033300
